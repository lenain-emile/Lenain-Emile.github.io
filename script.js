...
function initContactForm() {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    submitBtn.innerHTML = `
      ...
      <svg class="btn-icon spinning" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
